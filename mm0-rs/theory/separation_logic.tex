...
\begin{mathparpagebreakable}
  ...
  \infer[ty-inter]
    ...
    {\Gamma \proves \textstyle\bigcap\overline{\tau}\;\mathsf{type}}\and
  \infer[ty-union]
    {\forall i,\ \ \Gamma \proves \tau_i\;\mathsf{type}}
    {\Gamma \proves \textstyle\bigcup\overline{\tau}\;\mathsf{type}}\and
  \infer[ty-list]
    {\forall i,\ \ \Gamma \proves \tau_i\;\mathsf{type}}
    {\Gamma \proves \textstyle\Sep\overline{\tau}\;\mathsf{type}}\and
  \infer[ty-prop]
...
\begin{mathparpagebreakable}
  ...
  \infer[tye-mut]
    {\!\:{\Gamma;\delta \proves e_1\Rightarrow pe:\tau\makes\delta_1\quad
      ...
      \Gamma;\delta_1,(x\to y),(y^\gamma:=pe:\tau)\proves e_2:\tau'\makes\delta_2\quad y\notin \delta_2}}
    {\Gamma;\delta \proves (x^\gamma\gets e_1\ \mathsf{with}\ y\gets x;\ e_2):\tau'\makes\delta_2}\and
  \infer[tye-let-pure]
    {\!\:{\Gamma;\delta \proves e_1\Rightarrow pe:\tau\makes\delta_1\quad
      \Gamma\proves\tau',\delta_2\atop
      \Gamma,x:\core\tau;\delta_1,x^\gamma:=pe:\tau \proves e_2:\tau'\makes\delta_2}}
...
\begin{mathparpagebreakable}
  ...
  \infer[tye-struct-ref]
    {\!\:{\Gamma;\delta \proves e\Rightarrow(\eta:=pe:\tau)\makes\delta_1\;\mathsf{read}\atop
